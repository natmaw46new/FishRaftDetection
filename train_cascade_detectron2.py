...
# ============================================================
# Cascade Mask R-CNN variant of train_detectron2.py - identical setup
# (anchor sizes, rotation augmentation, RepeatFactorTrainingSampler, etc.)
# except for BASE_CONFIG and OUTPUT_DIR, so this can be trained and evaluated
# side-by-side against the plain Mask R-CNN baseline without overwriting it.
# Targets the AP50->AP75 gap specifically: cascade's 3-stage box refinement
# (IoU 0.5 -> 0.6 -> 0.7) is designed for exactly that failure mode.
# ============================================================
...
OUTPUT_DIR = "./data/cascade_model"

BASE_CONFIG = "Misc/cascade_mask_rcnn_R_50_FPN_3x.yaml"
